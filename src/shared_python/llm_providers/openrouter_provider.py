...
from backend.app.utils.thinking_config import get_thinking_config
...
class OpenRouterProvider:
    ...
    async def call_model(self, request: LLMRequest) -> LLMResponse:
        ...
        try:
            ...
            logger.info(
                ...
                has_system_prompt=bool(
                    request.system_prompt and request.system_prompt.strip()
                ),
        ...
        try:
            ...
            logger.error(
                "Failed to parse OpenRouter response", error=str(e), response=data
            )
