...
class EvaluationScheduler:
    ...
    def __init__(self):
        ...
        self.scan_intervals = {
            ...
            "leaderboard_only": timedelta(
                hours=2
            ),  # Quick leaderboard checks every 2 hours
        }
        ...
        try:
            ...
            for model_name, eval_data in model_evaluations.items():
                ...
                for theme_name, theme_data in theme_scores.items():
                    dynamic_scores[model_name]["theme_scores"][theme_name] = (
                        theme_data.get("score", 0) * 100
                    )
    ...
    async def get_evaluation_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            if self.model_selector.last_evaluation_update
            else None,
