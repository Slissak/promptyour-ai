...
class UserInputProcessor:
    ...
    async def process_input(self, user_input: StructuredUserInput) -> ProcessedContext:
        ...
        if not grade_level:
            grade_level = self._infer_grade_level(
                user_input.question, user_input.additional_context
            )

        # Calculate complexity score
        complexity_score = self._calculate_complexity_score(
            user_input.question, grade_level, subject
        )
    ...
    def _infer_grade_level(
        self, question: str, additional_context: str = None
    ) -> GradeLevel:
    ...
    def _calculate_complexity_score(
        self, question: str, grade_level: GradeLevel, subject: SubjectType
    ) -> float:
