...
async def get_evaluation_sources(active_only: bool = True) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"sources": sources, "count": len(sources), "active_only": active_only}
...
async def add_evaluation_source(
    source_name: str, source_config: SourceConfig
) -> Dict[str, Any]:
...
async def toggle_evaluation_source(
    source_name: str, active: bool = Body(...)
) -> Dict[str, Any]:
...
async def get_themes(active_only: bool = True) -> Dict[str, Any]:
    ...
    try:
        ...
        return {"themes": themes, "count": len(themes), "active_only": active_only}
...
async def get_theme_weights() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"theme_weights": weights, "themes_count": len(weights)}
...
async def update_theme_weights(
    theme_name: str, weights: ThemeWeights
) -> Dict[str, Any]:
...
async def update_feature_flag(
    feature_name: str, enabled: bool = Body(...)
) -> Dict[str, Any]:
...
async def get_scoring_config() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"scoring_config": scoring_config}
...
async def get_scheduler_config() -> Dict[str, Any]:
    ...
    try:
        ...
        return {"scheduler_config": scheduler_config}
