...
async def get_lm_studio_status():
    ...
    try:
        ...
        return {"success": True, "data": {"status": lm_status, "info": model_info}}
    except Exception as e:
        ...
        return {
            ...
            "data": {
                ...
                "api_key_configured": bool(
                    unified_provider.openrouter.api_key
                    and unified_provider.openrouter.api_key
...
async def troubleshoot_providers():
    ...
    diagnostics = {"timestamp": "2024-01-01T00:00:00Z", "checks": []}
        ...
        diagnostics["checks"].append(
            {
                ...
                else ["LM Studio is working correctly!"],
            }
        )
    except Exception as e:
        diagnostics["checks"].append(
    ...
    try:
        ...
        or_configured = bool(
            unified_provider.openrouter.api_key
            and unified_provider.openrouter.api_key != "your_openrouter_key_here"
        )
        ...
        diagnostics["checks"].append(
            {
                ...
                if not (or_healthy and or_configured)
                else ["OpenRouter is working correctly!"],
            }
        )
    except Exception as e:
        diagnostics["checks"].append(
