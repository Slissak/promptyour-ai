...
class EvaluationSource(Base):
    ...
    theme_mapping_config = Column(
        JSON, nullable=True
    )  # How to map scores to our themes
...
class ScrapingJob(Base):
    ...
    job_type = Column(
        String, nullable=False
    )  # "full_scan", "incremental", "single_source"
    source_name = Column(
        String, nullable=True, index=True
    )  # If scraping specific source
