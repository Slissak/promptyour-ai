...
from backend.app.models.schemas import UserInput, ThemeType, LLMRequest  # noqa: E402
from backend.app.services.chat_service import ChatService  # noqa: E402
from shared_python.llm_providers.openrouter_provider import OpenRouterProvider  # noqa: E402
...
async def test_complete_chat_pipeline():
    ...
    if (
        not chat_service.llm_provider.openrouter.api_key
        or chat_service.llm_provider.openrouter.api_key == "your_openrouter_key_here"
    ):
    ...
    for i, test_case in enumerate(test_cases):
        ...
        try:
            response = await chat_service.process_user_request(
                user_input=user_input, user_id=test_case["user_id"]
            )
